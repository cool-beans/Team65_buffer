...
#    url(r'^filter_events/(?P<event_id>\d+)$', 'app.views.filter_events', name='filter_events'),
    ...
    url(r'^event_cancel/(?P<event_id>\d+)$', 'app.views.events.cancel', name='cancel'),
    ...
    url(r'^event_cancel_attendance/(?P<event_id>\d+)$', 'app.views.events.cancel_attendance', name='cancel_attendance'),
    url(r'^event_cancel_following/(?P<event_id>\d+)$', 'app.views.events.cancel_following', name='cancel_following'),
    url(r'^event_cancel_all/(?P<event_id>\d+)$', 'app.views.events.cancel_all', name='cancel_all'),
   ...
   # Emails
    ...
    url(r'^send_email/$','app.views.emails.send', name='send_email'),
